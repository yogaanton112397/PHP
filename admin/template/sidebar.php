              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Master <span style="padding-left:2px;"> <i class="fa fa-caret-down"></i></span></span>
                      </a>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Transaksi <span style="padding-left:2px;"> <i class="fa fa-caret-down"></i></span></span>
                      </a>
                      <ul class="sub">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Laporan<span style="padding-left:2px;"> <i class="fa fa-caret-down"></i></span></span>
                      </a>
                      <ul class="sub">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          <i class="fa fa-cog"></i>
                          <span>Setting <span style="padding-left:2px;"> <i class="fa fa-caret-down"></i></span></span>
                      </a>
                      <ul class="sub">
